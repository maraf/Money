...
{
    /// <summary>
    /// Removes an exchange rate from <see cref="SourceUniqueCode"/> to <see cref="TargetUniqueCode"/>.
    /// It is valid from <see cref="ValidFrom"/> with exchange <see cref="Rate"/>.
    /// </summary>
    public class RemoveExchangeRate : Command
    {
        /// <summary>
        ...
        public RemoveExchangeRate(string sourceUniqueCode, string targetUniqueCode, DateTime validFrom, double rate)
        {
